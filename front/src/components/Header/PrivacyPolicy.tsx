...
const PrivacyPolicy = () => {
  return (
    <>
      <PageHelmet title="プライバシーポリシー" />
      <div className="flex items-start justify-center h-screen px-6 py-10 overflow-scroll">
        <div className="card w-full bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title text-4xl mb-7">プライバシーポリシー</h2>
            <h3 className="mb-2 text-2xl font-bold">お客様から取得する情報</h3>
            <p className="mb-2 font-bold">当社は、お客様から以下の情報を取得します。</p>
            <ul className="list-disc mb-5 px-6 font-bold">
            ...
            <h3 className="mb-2 text-2xl font-bold">お客様の情報を利用する目的</h3>
            ...
            <h3 className="mb-2 text-2xl font-bold">アクセス解析ツール</h3>
            <p className="mb-5 font-bold">
            ...
            <h3 className="mb-2 text-2xl font-bold">プライバシーポリシーの変更</h3>
            <p className="mb-5 font-bold">
            ...
            <h3 className="mb-2 text-2xl font-bold">お問い合わせ</h3>
            <p className="mb-5 font-bold">
